...
const useLoadSVGs = () => {
  const github = useSVGPicture(require("@/assets/images/skia/icons8-github.svg"));
  const octocat = useSVGPicture(require("@/assets/images/skia/icons8-octocat.svg"));
  const stackExchange = useSVGPicture(
    require("@/assets/images/skia/icons8-stack-exchange.svg")
  );
  const overflow = useSVGPicture(
    require("@/assets/images/skia/icons8-stack-overflow.svg")
  );
